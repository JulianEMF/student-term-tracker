...
public class AssessmentEndDateReceiver extends BroadcastReceiver {
    String channel_id = "assessmentEnd";
    static int endNotificationId;
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        Notification notification = new NotificationCompat.Builder(context,channel_id)
                ...
                .setContentTitle("Assessment Due Notification").build();
        NotificationManager notificationManager = (NotificationManager)context.getSystemService(NOTIFICATION_SERVICE);
        notificationManager.notify(endNotificationId++, notification);
    }
